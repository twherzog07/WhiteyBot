...
public class Video {
    ...
    public String toString() {
        return "Video{id='" + id + '\'' + ", title='" + title + '\'' + ", description='" + description + '\'' +
                ", broadcastID=" + broadcastID + ", status='" + status + '\'' + ", tagList='" + tagList + '\'' +
                ", recordedAt=" + recordedAt + ", game='" + game + '\'' + ", length=" + length + ", preview='" + preview + '\'' +
                ", url='" + url + '\'' + ", views=" + views + ", fps=" + fps + ", resolutions=" + resolutions +
                ", broadcastType='" + broadcastType + '\'' + ", channel=" + channel + '}';
    }
    ...
    public class ChannelSummary {
        ...
        @Override
        public String toString() {
            return "ChannelSummary{name='" + name + '\'' + ", displayName='" + displayName + '\'' + '}';
        }
