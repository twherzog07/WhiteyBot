...
public class Channel {
    ...
    public String toString() {
        return "ChannelSummary{mature=" + mature + ", status='" + status + '\'' +
                ", broadcasterLanguage='" + broadcasterLanguage + '\'' + ", displayName='" + displayName + '\'' +
                ", game'" + game + '\'' + ", delay=" + delay + ", language='" + language + '\'' +
                ", id=" + id + ", name='" + name + '\'' + ", createdAt=" + createdAt + ", updatedAt=" + updatedAt +
                ", logo='" + logo + '\'' + ", banner='" + banner + '\'' + ", videoBanner='" + videoBanner + '\'' +
                ", background='" + background + '\'' + ", profileBanner='" + profileBanner + '\'' +
                ", profileBannerBackgroundColor='" + profileBannerBackgroundColor + '\'' + ", partner=" + partner +
                ", url='" + url + '\'' + ", views=" + views + ", followers=" + followers + ", email='" + email + '\'' +
                ", streamKey='" + streamKey + '\'' + '}';
    }
}
